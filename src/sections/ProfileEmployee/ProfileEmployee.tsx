...
const ProfileEmployee: React.FC = () => {
  ...
  const { isAuthenticated: isAuthenticatedEmployee, handleDeleteEmployee } =
  ...
  const employeeData = tokenFromCookie
    ? (JSON.parse(tokenFromCookie) as EmployeeResponseDto)
    : null;
